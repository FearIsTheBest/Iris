-- Iris self-contained bundle for Roblox executors
-- Usage: loadstring(game:HttpGet('https://raw.githubusercontent.com/FearIsTheBest/Iris/master/loadstring.lua'))()

local _config_module = (function()
...
local _Internal_module = function(Iris)
    --[=[
        @class Internal
...
local _widget_Root = function(Iris, widgets)
...
local _widget_Window = function(Iris, widgets)
...
local _widget_Menu = function(Iris, widgets)
...
local _widget_Format = function(Iris, widgets)
    --stylua: ignore
...
local _widget_Text = function(Iris, widgets)
    --stylua: ignore
...
local _widget_Button = function(Iris, widgets)
...
local _widget_Checkbox = function(Iris, widgets)
    --stylua: ignore
...
local _widget_RadioButton = function(Iris, widgets)
    --stylua: ignore
...
local _widget_Image = function(Iris, widgets)
    local abstractImage = {
        hasState = false,
        hasChildren = false,
        Args = {
...
local _widget_Tree = function(Iris, widgets)
    local abstractTree = {
        hasState = true,
        hasChildren = true,
        Events = {
...
local _widget_Tab = function(Iris, widgets)
...
local _widget_Input = function(Iris, widgets)
    local numberChanged = {
...
local _widget_Combo = function(Iris, widgets)
    --stylua: ignore
...
local _widget_Plot = function(Iris, widgets)
    -- stylua: ignore
...
local _widget_Table = function(Iris, widgets)
...
local _widgets_init = function(Iris)
    local widgets = {}
    ...
    _widget_Root(Iris, widgets)
    _widget_Window(Iris, widgets)

    _widget_Menu(Iris, widgets)

    _widget_Format(Iris, widgets)

    _widget_Text(Iris, widgets)
    _widget_Button(Iris, widgets)
    _widget_Checkbox(Iris, widgets)
    _widget_RadioButton(Iris, widgets)
    _widget_Image(Iris, widgets)

    _widget_Tree(Iris, widgets)
    _widget_Tab(Iris, widgets)

    _widget_Input(Iris, widgets)
    _widget_Combo(Iris, widgets)
    _widget_Plot(Iris, widgets)

    _widget_Table(Iris, widgets)
end


local _API_module = function(Iris)
...
local _demoWindow_module = function(Iris)
...
local Internal = _Internal_module(Iris)
...
Iris.TemplateConfig = _config_module
...
Iris.ShowDemoWindow = _demoWindow_module(Iris)

_widgets_init(Internal)
_API_module(Iris)
...
local Text_    = Color3.fromRGB(255, 255, 255)
